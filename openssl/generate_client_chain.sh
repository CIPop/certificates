...
openssl x509 -req -in "${CERTFILE}.csr" -CA i2.pem -CAkey i2_key.pem -CAcreateserial -out "${CERTFILE}.pem" -days 365 -sha256 -extensions client_profile -extfile x509_client_config.cfg
