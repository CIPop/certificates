...
openssl req -new -key i1_key.pem -out i1_ec.csr -subj "/CN=$ICA1_NAME"
openssl x509 -req -in i1_ec.csr -CA ca_cert.pem -CAkey ca_key.pem -CAcreateserial -out i1_cert.pem -days 3650 -sha256

# Generate ICA2
openssl ecparam -out i2_key.pem -name prime256v1 -genkey
#openssl genrsa -out i2_key.pem 4096

openssl req -new -key i2_key.pem -out i2_ec.csr -subj "/CN=$ICA2_NAME"
openssl x509 -req -in i2_ec.csr -CA i1_cert.pem -CAkey i1_key.pem -CAcreateserial -out i2_cert.pem -days 3650 -sha256
